...
// End Cross Module References
	DEFINE_FUNCTION(ATank::execSetTankBarrelRef)
	{
		P_GET_OBJECT(UTankBarrel,Z_Param_BarrelToSet);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetTankBarrelRef(Z_Param_BarrelToSet);
		P_NATIVE_END;
	}
	void ATank::StaticRegisterNativesATank()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "SetTankBarrelRef", &ATank::execSetTankBarrelRef },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics
	{
		struct Tank_eventSetTankBarrelRef_Parms
		{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::NewProp_BarrelToSet_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::NewProp_BarrelToSet = { "BarrelToSet", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Tank_eventSetTankBarrelRef_Parms, BarrelToSet), Z_Construct_UClass_UTankBarrel_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::NewProp_BarrelToSet_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::NewProp_BarrelToSet_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::NewProp_BarrelToSet,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::Function_MetaDataParams[] = {
		{ "Category", "Setup" },
		{ "ModuleRelativePath", "Public/Tank.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATank, nullptr, "SetTankBarrelRef", nullptr, nullptr, sizeof(Tank_eventSetTankBarrelRef_Parms), Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATank_SetTankBarrelRef()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ATank_SetTankBarrelRef_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATank_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATank_SetTankBarrelRef, "SetTankBarrelRef" }, // 4234508192
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ATank, 89514437);
